...
void fillSampleData() {
  ...
  sampleRecords[4] = new SmartTableRecord('Melissa', 26, Sex.female(),
      new Department('Italy dept.'), new Address("Rome", "Juliano str.", '65'));

  sampleRecords[5] = new SmartTableRecord(
      'Santyago',
      30,
      Sex.male(),
      new Department('Spain dept.'),
  ...
  sampleRecords[7] = new SmartTableRecord(
      ...
      43,
      Sex.male(),
      new Department('Finland dept.'),
      new Address("Helsinki", "Simonkatu str.", '2'));

  sampleRecords[8] = new SmartTableRecord('John', 52, Sex.male(),
      new Department('UK dept.'), new Address("London", "King str.", '5C'));
